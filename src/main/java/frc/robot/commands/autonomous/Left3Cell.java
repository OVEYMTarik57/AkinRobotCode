...
public class Left3Cell extends SequentialCommandGroup {
   ...
   */
  public Left3Cell(SneakyTrajectory s_trajectory, ShooterSubsystem shooter, IntakeSubsystem intake, HopperSubsystem hopper, DriveSubsystem drive, TransferSubsystem transfer ) {
